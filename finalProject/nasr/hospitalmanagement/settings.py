...
def home(request):
    images_dir = os.path.join(settings.STATIC_ROOT, 'assets', 'images')  # Path to your images directory
    images_list = os.listdir(images_dir)
    images = [{'name': image, 'url': f"{settings.STATIC_URL}assets/images/{image}"} for image in images_list if image.endswith(('.jpg', '.png', '.jpeg', '.gif'))]
import os
